            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-6 col-md-8">
                    ...
                    <form method="POST" action="{{ route('admin.houses.update', $house->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-4">
                                <label for="postalCode" class="col-form-label fw-bold">郵便番号</label>
                            </div>
                            <div class="col-md-8">
                                @error('postalCode')
                                    <div class="text-danger small mb-2">{{ $message }}</div>
                                @enderror
                                <input type="text" name="postalCode" id="postalCode" class="form-control" value="{{ old('postalCode', $house->postal_code) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-4">
                                <label for="phoneNumber" class="col-form-label fw-bold">電話番号</label>
                            </div>
                            <div class="col-md-8">
                                @error('phoneNumber')
                                    <div class="text-danger small mb-2">{{ $message }}</div>
                                @enderror
                                <input type="text" name="phoneNumber" id="phoneNumber" class="form-control" value="{{ old('phoneNumber', $house->phone_number) }}">
                            </div>
                        </div>
